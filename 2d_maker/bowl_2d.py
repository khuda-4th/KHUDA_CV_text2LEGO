...
modelnet40_folder = 'ModelNet40/bowl'
...
for split in ['train', 'test']:
    ...
    for file_name in os.listdir(data_folder):
        if file_name.endswith('.off'):
            ...
            z_model_center = (model_extents[0] + model_extents[1]) / 3.0 + max_bound[2] / 3.0
            pose = np.array([
            ...
            yaw, pitch, roll = np.radians(0), np.radians(0), np.radians(45)
