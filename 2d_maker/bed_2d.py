...
modelnet40_folder = 'ModelNet40/bed'
...
for split in ['train', 'test']:
    ...
    for file_name in os.listdir(data_folder):
        if file_name.endswith('.off'):
            ...
            z_model_center = (model_extents[0] + model_extents[1]) / 3 + max_bound[2] / 3.5
            pose = np.array([
            ...
            yaw, pitch, roll = np.radians(0), np.radians(0), np.radians(40)
